...
#define __PYX_HAVE__pbc_adjustment
#define __PYX_HAVE_API__pbc_adjustment
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'pbc_adjustment' */
...
#define __Pyx_MODULE_NAME "pbc_adjustment"
extern int __pyx_module_is_main_pbc_adjustment;
int __pyx_module_is_main_pbc_adjustment = 0;

/* Implementation of 'pbc_adjustment' */
...
static const char __pyx_k_pbc_adjust[] = "pbc_adjust";
...
static const char __pyx_k_pbc_adjustment[] = "pbc_adjustment";
...
static const char __pyx_k_pbc_adjustment_pyx[] = "pbc_adjustment.pyx";
...
static PyObject *__pyx_n_s_pbc_adjust;
static PyObject *__pyx_n_s_pbc_adjustment;
static PyObject *__pyx_kp_s_pbc_adjustment_pyx;
...
static PyObject *__pyx_pf_14pbc_adjustment_pbc_adjust(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_coords, __Pyx_memviewslice __pyx_v_box); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_14pbc_adjustment_1pbc_adjust(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_14pbc_adjustment_1pbc_adjust = {"pbc_adjust", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_14pbc_adjustment_1pbc_adjust, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_14pbc_adjustment_1pbc_adjust(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_coords = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_box = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("pbc_adjust (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_box)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("pbc_adjust", 1, 2, 2, 1); __PYX_ERR(0, 1, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "pbc_adjust") < 0)) __PYX_ERR(0, 1, __pyx_L3_error)
      }
    ...
    __pyx_v_coords = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_coords.memview)) __PYX_ERR(0, 1, __pyx_L3_error)
    __pyx_v_box = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_box.memview)) __PYX_ERR(0, 1, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("pbc_adjust", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 1, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pbc_adjustment.pbc_adjust", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14pbc_adjustment_pbc_adjust(__pyx_self, __pyx_v_coords, __pyx_v_box);
...
static PyObject *__pyx_pf_14pbc_adjustment_pbc_adjust(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_coords, __Pyx_memviewslice __pyx_v_box) {
  ...
  __Pyx_RefNannySetupContext("pbc_adjust", 0);

  /* "pbc_adjustment.pyx":2
 * def pbc_adjust(double[:,:] coords, double[:] box):
 *     for i in range(coords.shape[0]):             # <<<<<<<<<<<<<<
 *         for j in range(3):
 *             coords[i, j] -= round(coords[i, j] / box[j]) * box[j]
 */
  __pyx_t_1 = (__pyx_v_coords.shape[0]);
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "pbc_adjustment.pyx":3
 * def pbc_adjust(double[:,:] coords, double[:] box):
 *     for i in range(coords.shape[0]):
 *         for j in range(3):             # <<<<<<<<<<<<<<
 *             coords[i, j] -= round(coords[i, j] / box[j]) * box[j]
 ...
 */
      ...
      } else if (unlikely(__pyx_t_5 >= __pyx_v_coords.shape[0])) __pyx_t_7 = 0;
      if (__pyx_t_6 < 0) {
        __pyx_t_6 += __pyx_v_coords.shape[1];
        if (unlikely(__pyx_t_6 < 0)) __pyx_t_7 = 1;
      } else if (unlikely(__pyx_t_6 >= __pyx_v_coords.shape[1])) __pyx_t_7 = 1;
      if (unlikely(__pyx_t_7 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_7);
        __PYX_ERR(0, 4, __pyx_L1_error)
      }
      __pyx_t_8 = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_5 * __pyx_v_coords.strides[0]) ) + __pyx_t_6 * __pyx_v_coords.strides[1]) )));
      __pyx_t_9 = __pyx_v_j;
      __pyx_t_7 = -1;
      if (__pyx_t_9 < 0) {
        __pyx_t_9 += __pyx_v_box.shape[0];
        if (unlikely(__pyx_t_9 < 0)) __pyx_t_7 = 0;
      } else if (unlikely(__pyx_t_9 >= __pyx_v_box.shape[0])) __pyx_t_7 = 0;
      if (unlikely(__pyx_t_7 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_7);
        __PYX_ERR(0, 4, __pyx_L1_error)
      }
      __pyx_t_10 = (*((double *) ( /* dim=0 */ (__pyx_v_box.data + __pyx_t_9 * __pyx_v_box.strides[0]) )));
      if (unlikely(__pyx_t_10 == 0)) {
        PyErr_SetString(PyExc_ZeroDivisionError, "float division");
        __PYX_ERR(0, 4, __pyx_L1_error)
      }
      __pyx_t_11 = PyFloat_FromDouble((__pyx_t_8 / __pyx_t_10)); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 4, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_11);
      __pyx_t_12 = __Pyx_PyObject_CallOneArg(__pyx_builtin_round, __pyx_t_11); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 4, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_12);
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
      __pyx_t_13 = __pyx_v_j;
      __pyx_t_7 = -1;
      if (__pyx_t_13 < 0) {
        __pyx_t_13 += __pyx_v_box.shape[0];
        if (unlikely(__pyx_t_13 < 0)) __pyx_t_7 = 0;
      } else if (unlikely(__pyx_t_13 >= __pyx_v_box.shape[0])) __pyx_t_7 = 0;
      if (unlikely(__pyx_t_7 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_7);
        __PYX_ERR(0, 4, __pyx_L1_error)
      }
      __pyx_t_11 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_box.data + __pyx_t_13 * __pyx_v_box.strides[0]) )))); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 4, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_11);
      __pyx_t_14 = PyNumber_Multiply(__pyx_t_12, __pyx_t_11); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 4, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);
      __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
      __pyx_t_10 = __pyx_PyFloat_AsDouble(__pyx_t_14); if (unlikely((__pyx_t_10 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L1_error)
      ...
      } else if (unlikely(__pyx_t_15 >= __pyx_v_coords.shape[0])) __pyx_t_7 = 0;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_v_coords.shape[1];
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_7 = 1;
      } else if (unlikely(__pyx_t_16 >= __pyx_v_coords.shape[1])) __pyx_t_7 = 1;
      if (unlikely(__pyx_t_7 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_7);
        __PYX_ERR(0, 4, __pyx_L1_error)
      }
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_15 * __pyx_v_coords.strides[0]) ) + __pyx_t_16 * __pyx_v_coords.strides[1]) )) -= __pyx_t_10;
    }
  }
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pbc_adjustment.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pbc_adjustment._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_pbc_adjustment(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_pbc_adjustment},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_pbc_adjust, __pyx_k_pbc_adjust, sizeof(__pyx_k_pbc_adjust), 0, 0, 1, 1},
  {&__pyx_n_s_pbc_adjustment, __pyx_k_pbc_adjustment, sizeof(__pyx_k_pbc_adjustment), 0, 0, 1, 1},
  {&__pyx_kp_s_pbc_adjustment_pyx, __pyx_k_pbc_adjustment_pyx, sizeof(__pyx_k_pbc_adjustment_pyx), 0, 0, 1, 0},
 ...
 *         for j in range(3):
 */
  __pyx_tuple__19 = PyTuple_Pack(4, __pyx_n_s_coords, __pyx_n_s_box, __pyx_n_s_i, __pyx_n_s_j); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(2, 0, 4, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pbc_adjustment_pyx, __pyx_n_s_pbc_adjust, 1, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 1, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initpbc_adjustment(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initpbc_adjustment(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_pbc_adjustment(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_pbc_adjustment(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_pbc_adjustment(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'pbc_adjustment' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_pbc_adjustment(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("pbc_adjustment", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pbc_adjustment) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pbc_adjustment")) {
      if (unlikely(PyDict_SetItemString(modules, "pbc_adjustment", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *         for j in range(3):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_14pbc_adjustment_1pbc_adjust, NULL, __pyx_n_s_pbc_adjustment); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_pbc_adjust, __pyx_t_1) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pbc_adjustment", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pbc_adjustment");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
